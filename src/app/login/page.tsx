  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-20 px-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-cyan-500/10 blur-[120px]" />
      </div>
      ...
      <div className="w-full max-w-md glass p-8 md:p-10 rounded-3xl border border-white/10 shadow-2xl z-10">
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-slate-400 text-sm md:text-base text-center">
            Đăng nhập để trải nghiệm AI mạnh mẽ nhất
          </p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all text-white placeholder:text-slate-500"
                value={email}
          ...
          <div className="space-y-1.5 pb-2">
            <div className="flex justify-between items-center ml-1">
              ...
              <Link href="#" className="text-xs text-emerald-400 hover:text-cyan-400 transition-colors">
                Quên mật khẩu?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-6 mb-6 flex items-center gap-3">
          ...
          <span className="text-xs text-slate-500 uppercase font-medium">Hoặc tiếp tục với</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-400">
          Chưa có tài khoản?{" "}
          <Link href={`/register${redirectParams ? `?redirect=\${redirectParams}` : ''}`} className="text-cyan-400 font-medium hover:text-emerald-400 transition-colors">
            Đăng ký ngay
          </Link>
        </p>
      </div>
